...
namespace Application.Branches
{
    public class List
    {
        ...
        private readonly IUserAccessor userAccessor;
            ...
            {
                var query =  this.context.Branches
                .OrderBy(d => d.Bank)
               .ProjectTo<BranchDto>(this.mapper.ConfigurationProvider, new
               ...
               return Result<PagedList<BranchDto>>.Success(
                    ...
                    await PagedList<BranchDto>.CreateAsync(query, request.Params.PageNumber,
